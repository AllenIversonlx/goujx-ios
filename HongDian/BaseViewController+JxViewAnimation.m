//
//  BaseViewController+JxViewAnimation.m
//  HongDian
//
...
@interface BaseViewController (KNSemiModalInternal)
-(UIView*)parentTarget;
-(CAAnimationGroup*)animationGroupForward:(BOOL)_forward;

@end

@implementation BaseViewController (KNSemiModalInternal)
...
@implementation BaseViewController (JxViewAnimation)
